...
## Instale o UV ou o gerênciador de pacotes Python de sua preferência

Instruções para instalar o uv disponível no site [astral.sh](https://docs.astral.sh/uv/getting-started/installation)
